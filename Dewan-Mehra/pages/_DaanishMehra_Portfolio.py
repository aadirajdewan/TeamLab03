...
st.title("Daanish's Portfolio")
st.write("""
This interactive Streamlit app is designed to highlight Daanish Mehra's educational background, work experience, projects, and skills.
""")
